...
class Attention(nn.Module):
    def __init__(self, dim, num_heads=8, qkv_bias=False, qk_scale=None, attn_drop=0., proj_drop=0., attn_head_dim=None, temperature=1.0):
        super().__init__()
    ...
    def forward(self, x):
        ...
        cov = (q @ k.transpose(-2, -1)) / self.temperature  # Apply temperature scaling to covariance matrix
...
class TransformerEncoderLayer(BaseModule):
    ...
    proj_drop=drop_rate,
    attn_head_dim=None,  # Set this if you have a specific value, otherwise keep it as None
